...
<head>
    ...
    <title>Winelists - Register</title>
</head>
<body>
    <div class="container-fluid ps-0 pe-0">
        ...
        <main class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h1 class="pt-5 mb-4">Create your account</h1>
                    <form action="/public/actions/register.php" method="post">
                        <div class="form-row">
                            <div class="col-lg-7 mb-3">
                                <input type="text" placeholder="Full Name" class="form-control p-2" id="fullName" name="name">
                                <p class="alert-fullName text-danger p-0">*Must be only characters without spaces!!</p>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7 mb-3">
                                <input type="email" placeholder="Email Address" class="form-control p-2" id="email" name="email">
                                <p class="alert-email text-danger p-0">*Must be a valid email address!!</p>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7 mb-3">
                                <input type="password" placeholder="Password" class="form-control p-2" id="password" name="password">
                                <p class="alert-password text-danger p-0">*Password must have at least 8 characters!!</p>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7 mb-3">
                                <button style="width:100%;border-radius:0;"type="submit" class="btn btn-dark p-2 disabled" id="register">Register</button>
                            </div>
                        </div>
                    </form>
                </div>
